...
/**
 * Interface for header activities.
 * 
 * Header activities control the content of the header.
 */
public interface HeaderActivity extends CoreActivity, HeaderView.Presenter {
